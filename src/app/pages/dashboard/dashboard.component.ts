...
import { faMoon, faSnowflake, faSun } from '@fortawesome/free-regular-svg-icons';
import { faArrowRotateRight, faCloud, faCloudBolt, faCloudMoon, faCloudMoonRain, faCloudRain, faCloudSun, faCloudSunRain, faDroplet, faSmog, faWind } from '@fortawesome/free-solid-svg-icons';
